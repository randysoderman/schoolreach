export const US_STATES = [
  { code: "AL", name: "Alabama", fips: 1 },
  { code: "AK", name: "Alaska", fips: 2 },
  { code: "AZ", name: "Arizona", fips: 4 },
  { code: "AR", name: "Arkansas", fips: 5 },
  { code: "CA", name: "California", fips: 6 },
  { code: "CO", name: "Colorado", fips: 8 },
  { code: "CT", name: "Connecticut", fips: 9 },
...
export function fipsForCode(code: string): number | undefined {
  return US_STATES.find((s) => s.code === code)?.fips;
}

export function codeForFips(fips: number): string | undefined {
  return US_STATES.find((s) => s.fips === fips)?.code;
}
